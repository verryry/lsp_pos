  ...
  <div class="wrapper">
    ...
    <fieldset>
      <div class="form-group">
        ...
        <div class="col-lg-10">
          <input type="text" name="nama" class="form-control" id="nama" placeholder="Nama Product">
        </div>
      </div>
      <div class="form-group">
        <label for="harga_jual" class="col-lg-2 control-label">Harga Jual</label>
        <div class="col-lg-10">
          <input type="number" min="0" name="harga_jual" class="form-control" id="harga_jual" placeholder="Harga Jual">
        </div>
      </div>
      <div class="form-group">
        <label for="harga_beli" class="col-lg-2 control-label">Harga Beli</label>
        <div class="col-lg-10">
          <input type="number" min="0" name="harga_beli" class="form-control" id="harga_beli" placeholder="Harga Beli">
        </div>
      </div>
      <div class="form-group">
        <label for="disc" class="col-lg-2 control-label">Diskon</label>
        <div class="col-lg-10">
          <input type="number" min="0" name="disc" class="form-control" id="disc" placeholder="Diskon">
        </div>
      </div>
      <div class="form-group">
      ...
      <div class="form-group">
        ...
        <div class="col-lg-10">
          <input type="number" min="0" name="stok" class="form-control" id="stok" placeholder="Stok">
        </div>
      </div>
      <div class="form-group">
        ...
        <div class="col-lg-10">
          <select class="form-control" name="id_unit">
            <option selected="true" disabled="disabled">Chooise Unit</option>
      ...
      <div class="form-group">
        ...
        <div class="col-lg-10">
          <select class="form-control" name="id_curr">
            <option selected="true" disabled="disabled">Chooise Curr</option>
      ...
      <div class="form-group">
        ...
        <div class="col-lg-10">
          <select class="form-control" name="id_kategori">
            <option selected="true" disabled="disabled">Chooise Kategori</option>
      ...
      <div class="form-group">
        ...
        <div class="col-lg-10">
          <textarea style="height:auto !important;" class="form-control" rows="10" name="keterangan" placeholder="Keterangan"></textarea>
        </div>
      </div>
      <div class="form-group">
